...
/***/ "../components/comments.component.ts":
/*!*******************************************!*\
  !*** ../components/comments.component.ts ***!
  \*******************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Favorites\": function() { return /* binding */ Favorites; }\n/* harmony export */ });\n/* harmony import */ var _core_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/component */ \"../core/component.ts\");\n/* harmony import */ var _core_componentsObj__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/componentsObj */ \"../core/componentsObj.ts\");\n/* harmony import */ var _params_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./params.component */ \"../components/params.component.ts\");\n/* harmony import */ var _src_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src/index */ \"./index.ts\");\n\n\n\n\nclass Favorites extends _core_component__WEBPACK_IMPORTED_MODULE_0__.Component {\n  constructor(id) {\n    super(id);\n  }\n  init() {\n    this.$el.addEventListener('click', favoriteButtonHandler.bind(this));\n  }\n}\nfunction favoriteButtonHandler() {\n  this.$el.classList.add('active');\n  _core_componentsObj__WEBPACK_IMPORTED_MODULE_1__.objectComponent.input.classList.add('hide');\n  (0,_core_componentsObj__WEBPACK_IMPORTED_MODULE_1__.deleteAll)();\n  let comments = JSON.parse(localStorage.getItem('comments'));\n  let answers = JSON.parse(localStorage.getItem('answers'));\n  let commentsFilter = [];\n  let answersFilter = [];\n  const menu = _core_componentsObj__WEBPACK_IMPORTED_MODULE_1__.objectComponent.menu;\n  comments.forEach(e => {\n    if (e.isFavorite === true) {\n      commentsFilter.push(e);\n    }\n  });\n  if (answers) {\n    answers.forEach(a => {\n      if (a.isFavorite === true) {\n        answersFilter.push(a);\n      }\n    });\n  }\n  // только комменты\n  if (commentsFilter.length !== 0 && answersFilter.length === 0) {\n    for (let i = 0; i < commentsFilter.length; i++) {\n      (0,_core_componentsObj__WEBPACK_IMPORTED_MODULE_1__.inputCommentToHtml)(commentsFilter[i], menu);\n    }\n  }\n\n  // только ответы\n  else if (answersFilter.length !== 0 && commentsFilter.length === 0) {\n    for (let i = 0; i < answersFilter.length; i++) {\n      (0,_core_componentsObj__WEBPACK_IMPORTED_MODULE_1__.inputAnswersToHtml)(answersFilter[i], menu);\n    }\n  }\n  // самый актуальный вариант\n  else if (answersFilter.length !== 0 && commentsFilter.length !== 0) {\n    for (let i = 0; i < commentsFilter.length; i++) {\n      (0,_core_componentsObj__WEBPACK_IMPORTED_MODULE_1__.inputCommentToHtml)(commentsFilter[i]);\n    }\n    for (let i = 0; i < answersFilter.length; i++) {\n      (0,_core_componentsObj__WEBPACK_IMPORTED_MODULE_1__.inputAnswersToHtml)(answersFilter[i]);\n    }\n  } else if (comments.length === 0 && answers.length === 0) {\n    const menu = document.querySelector('.menu');\n    const titleFavotite = document.createElement('div');\n    titleFavotite.innerHTML = ' В избранном пока ничего нет';\n    titleFavotite.classList.add('titleFavorite');\n    menu.after(titleFavotite);\n  }\n  (0,_params_component__WEBPACK_IMPORTED_MODULE_2__.searchRating)();\n  (0,_src_index__WEBPACK_IMPORTED_MODULE_3__.createParams)('params');\n  // когда нет ничего в избранном\n}\n\n//# sourceURL=webpack:///../components/favorites.component.ts?");

/***/ }),

/***/ "../components/input-answer.component.ts":
/*!***********************************************!*\
  !*** ../components/input-answer.component.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"InputMessage\": function() { return /* binding */ InputMessage; }\n/* harmony export */ });\n/* harmony import */ var _core_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/component */ \"../core/component.ts\");\n/* harmony import */ var _core_componentsObj__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/componentsObj */ \"../core/componentsObj.ts\");\n/* harmony import */ var _params_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./params.component */ \"../components/params.component.ts\");\n/* harmony import */ var _src_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src//index */ \"./index.ts\");\n\n\n\n\nclass InputMessage extends _core_component__WEBPACK_IMPORTED_MODULE_0__.Component {\n  constructor(id) {\n    super(id);\n  }\n  init() {\n    this.$el.addEventListener('input', showSymbols.bind(this));\n    this.$el.addEventListener('click', sendBtn.bind(this));\n  }\n}\nlet inputValue;\nfunction showSymbols(e) {\n  inputValue = document.querySelector('.input__message').value.length;\n  if (e.target.classList.contains('input__message')) {\n    console.log(inputValue);\n    const inputMax = document.querySelector('.input__max');\n    console.log(inputMax);\n    const btn = e.target.nextElementSibling;\n    if (inputValue > 1 || inputValue < 1000) {\n      if (inputValue === 0) {\n        btn.classList.remove('input_btn-color');\n      } else {\n        btn.classList.add('input_btn-color');\n        inputMax.style.cssText = '';\n      }\n    }\n    inputMax.innerHTML = `${inputValue}/1000`;\n    if (inputValue > 1000) {\n      inputMax.style.cssText = 'font-weight: 700; color: red; opacity: 1';\n      btn.classList.remove('input_btn-color');\n    }\n  }\n}\nfunction sendBtn(e) {\n  let num = Number(JSON.parse(localStorage.getItem('NUM'))) || 0;\n  if (inputValue < 1000 && inputValue !== 0) {\n    if (e.target.classList.contains('input_btn')) {\n      let comments = JSON.parse(localStorage.getItem('comments')) || [];\n      console.log(inputValue);\n      const commentariy = {\n        idOfComment: num,\n        avatar: document.querySelector('.avatar-img').src,\n        text: document.querySelector('.input__message')['value'],\n        name: document.querySelector('.input__name').innerText,\n        date: {\n          data: new Date().toLocaleDateString(),\n          hours: new Date().getHours(),\n          minutes: new Date().getMinutes()\n        },\n        isFavorite: false,\n        rating: 0\n      };\n      comments.push(commentariy);\n      console.log(' Комментарий', commentariy);\n      console.log(comments);\n      setCommentToLocalStorage(comments, commentariy);\n      num++;\n      localStorage.setItem('NUM', String(num));\n    }\n  }\n}\nfunction setCommentToLocalStorage(comments, commentariy) {\n  localStorage.setItem(`comments`, JSON.stringify(comments));\n  (0,_core_componentsObj__WEBPACK_IMPORTED_MODULE_1__.inputCommentToHtml)(commentariy);\n  (0,_params_component__WEBPACK_IMPORTED_MODULE_2__.searchRating)();\n  (0,_src_index__WEBPACK_IMPORTED_MODULE_3__.createParams)('params');\n}\n\n//# sourceURL=webpack:///../components/input.component.ts?");

/***/ }),

/***/ "../components/params.component.ts":
/*!*****************************************!*\
  !*** ../components/params.component.ts ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Component\": function() { return /* binding */ Component; }\n/* harmony export */ });\nclass Component {\n  constructor(id) {\n    if (id === 'params') {\n      this.$list = document.getElementsByClassName('params');\n    } else {\n      this.$el = document.getElementById(id);\n    }\n    this.init();\n  }\n  init() {}\n  onShow() {}\n  onHide() {}\n  hide() {\n    this.$el.classList.add('hide');\n    this.onHide();\n  }\n  show() {\n    this.$el.classList.remove('hide');\n    this.onShow();\n  }\n}\n\n//# sourceURL=webpack:///../core/component.ts?");

/***/ }),

/***/ "../core/componentsObj.ts":
/*!********************************!*\
  !*** ../core/componentsObj.ts ***!
  \********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"createParams\": function() { return /* binding */ createParams; },\n/* harmony export */   \"params\": function() { return /* binding */ params; }\n/* harmony export */ });\n/* harmony import */ var _components_comments_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/comments.component */ \"../components/comments.component.ts\");\n/* harmony import */ var _components_favorites_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/favorites.component */ \"../components/favorites.component.ts\");\n/* harmony import */ var _components_input_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/input.component */ \"../components/input.component.ts\");\n/* harmony import */ var _components_params_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/params.component */ \"../components/params.component.ts\");\n\n\n\n\nconst comments = new _components_comments_component__WEBPACK_IMPORTED_MODULE_0__.Comments('comments');\nconst favorites = new _components_favorites_component__WEBPACK_IMPORTED_MODULE_1__.Favorites('favorites');\nconst input = new _components_input_component__WEBPACK_IMPORTED_MODULE_2__.InputMessage('input');\nlet params;\ndocument.addEventListener('DOMContentLoaded', () => {});\nfunction createParams(id) {\n  params = new _components_params_component__WEBPACK_IMPORTED_MODULE_3__.Params(id);\n  console.log(params);\n}\n\n//# sourceURL=webpack:///./index.ts?");
